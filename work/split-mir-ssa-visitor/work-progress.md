...
- MIR→SSA skeleton added under `lang2/stage4/ssa.py` (single-block straight-line SSA with load/store version checks and multi-block rejection guards); unit tests in `lang2/stage4/tests/test_mir_to_ssa.py`.  
