...
from lang.driftc.stage2 import BasicBlock, MirFunc, StoreLocal, LoadLocal, Return, Goto, IfTerminator
...
def test_phi_placed_in_join_for_local_defined_in_branches():
	...
	from lang.driftc.stage2 import Phi  # local import to keep test narrow
	...
	from lang.driftc.stage2 import AssignSSA
