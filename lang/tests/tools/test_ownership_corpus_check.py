...
@pytest.mark.xfail(reason="pre-first-promotion: fingerprint.json is generated by the "
                          "first real `just ownership-corpus-promote`; remove this xfail "
                          "in the commit that lands the promoted baseline",
                   strict=True)
