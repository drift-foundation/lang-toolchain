...
from lang.driftc.stage2 import DropValue, HIRToMIR, MoveOut, VariantGetFieldAddr, make_builder
...
def test_match_by_value_noncopy_binder_moves_payload_and_zeros_source() -> None:
	...
	assert any(isinstance(instr, MoveOut) and instr.ty == string_tid for instr in all_instrs)
